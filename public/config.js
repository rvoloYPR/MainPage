...
const CONFIG = {
    ...
    // Backend API URL - Uses same-origin by default (secure)
    // When frontend and backend are on the same domain, this is the most secure approach
    API_BASE_URL: (
        window.location.hostname === 'localhost' ||
        window.location.hostname === '127.0.0.1' ||
        window.location.hostname === '' ||
        ...
        : 'https://mainpage-5wb3.onrender.com', // Production backend
};
